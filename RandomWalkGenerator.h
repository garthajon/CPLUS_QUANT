 ...
 // #ifndef and #define are preprocessor directives that prevent the same header file from
 // being included multiple times in a single compilation unit.
 // this will avoid errors caused by redefining variables, functions, clases etc if header file
